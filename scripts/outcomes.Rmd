...
df <- read_excel("../data/YJ_Stats_Outcomes_Data_2020_21.xlsx", sheet = "Data")
...
<B>Cautions and court sentences given to children (per 1,000) of general 10-17 population, from 1st of April 2020 to 31st March 2021.</B>
...
table_data %>%
  reactable( style=list(fontSize="12px"),sortable = TRUE,minRows= 10,defaultPageSize = 160,compact=TRUE,
             columns = list(
               ...
               Region_Number= colDef(name="Number of cautions or sentences",width = 100,format = colFormat(separators = TRUE)),
...
table_data %>%
  reactable(style=list(fontSize="12px"),sortable = TRUE,minRows= 154,defaultPageSize = 160,compact=TRUE,
             columns = list(
               ...
               YOT_Number= colDef(name="Number of cautions or sentences",width = 80,format = colFormat(separators = TRUE)),
